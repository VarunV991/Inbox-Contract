...
beforeEach(async () => {
    ...
    inbox = await new web3.eth.Contract(JSON.parse(interface))  // Informs the web3 about the methods the Inbox Contract has (Info about the instance)
        .deploy({data: bytecode, arguments: ['Hi There!']})     // Tells the web3 we want to deploy a copy of the contract (Creates the instance)
